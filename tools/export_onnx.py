...
def make_parser():
    ...
    parser.add_argument("--output-name", type=str, default="yolox_m.onnx",
    ...
    parser.add_argument("-f", "--exp_file", default='../exps/default/yolox_m.py', type=str,
                        help="expriment description file",)
    parser.add_argument("-expn", "--experiment-name", type=str, default=None)
    parser.add_argument("-n", "--name", type=str, default='yolox_m',
                        help="model name")
    parser.add_argument("-c", "--ckpt", default='E:/yolox_m.pth.tar', type=str,
                        help="ckpt path")
